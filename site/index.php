  ...
  <body>
    <div class="container">
      ...
      <div class="span-6 last">
        <a href="http://qgis.org"><img src="img/qgis-icon.png"></img></a>
      </div>
      <hr>
      <div class="span-18 colborder">
        ...
        <div>
          <ul class="map-list">
			...
			if ($handle = opendir('../projects')) {
				...
				while (false !== ($file = readdir($handle))) {
					if(!is_dir($file) && substr($file, -strlen($ending)) === $ending){
						echo '<li class="map-item"><a href="qgiswebclient.php?map=/home/user/QGIS-Web-Client/projects/';
						echo $file;
						echo '">';
						echo $file . '</a></li>';
					}
		  ...
		  <!--
            ...
            <li class="map-item"><a href="qgiswebclient.html?map=/home/user/QGIS-Web-Client/projects/helloworld.qgs">HelloWorld (Projection WGS84/Pseudo Mercator - EPSG 3857)</a></li>
            <li class="map-item"><a href="qgiswebclient.html?map=/home/user/QGIS-Web-Client/projects/naturalearth_110million.qgs">NaturalEarth (Projection WGS84/Pseudo Mercator - EPSG 3857)</a></li>
